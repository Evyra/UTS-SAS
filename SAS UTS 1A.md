...
1. Buka Server Manager lalu pilih menu <b>Manage -> "Add Roles and Features"</b>
   ...
   <img width="512" alt="2d" src="https://user-images.githubusercontent.com/93085602/143681987-5bbe9c47-a961-4513-b341-1707b30c40d8.PNG">

2. Selanjutnya kita akan menggunakan aturan default dari sistem <b>"Role-based or feature-based installation"</b> lalu NEXT

   <img width="513" alt="3d" src="https://user-images.githubusercontent.com/93085602/143681958-5eb4910b-c592-4db1-aac7-d561c7e614f0.PNG">
...
4. NEXT
   ...
   <img width="510" alt="5d" src="https://user-images.githubusercontent.com/93085602/143682006-39703450-dd52-4d37-b555-0725e14be92e.PNG">
...
7. Akan muncul konfirmasi apakah kita tetap lanjut menginstall<b>".NET Framework 3.5 Features"</b>. Pilih <b>"INSTALL"</b>
   ...
   <img width="513" alt="7d" src="https://user-images.githubusercontent.com/93085602/143682133-c12eb710-1398-4087-813c-f119e74c58b1.PNG">

11. Instalasi selesai

   <img width="513" alt="9d" src="https://user-images.githubusercontent.com/93085602/143682156-b7f43e3e-b4af-47f3-a7ee-35d9c67b4a32.PNG">
...
1. Buka Server Manager lalu pilih peringatan yang ada. Pilih <b>"Promote this server to a domain controller"</b> 
   ...
   <img width="514" alt="1e" src="https://user-images.githubusercontent.com/93085602/143682217-a2b6f6fe-0d6d-4584-8ddf-250edab40e1e.PNG">
...
2. Pilih checkbox <b>"Add a new Forest"</b> lalu isi root domain name yang diinginkan dengan menggunakan <b>(dot/titik)</b> pada root domain name lalu NEXT
   ...
   <img width="513" alt="2e" src="https://user-images.githubusercontent.com/93085602/143682287-735ec62b-31c3-4964-bd56-a2bbca3c75a1.PNG">

3. Pada "Domain Controller Option", isilah password yang memuat(capslock, symbol, angka) lalu NEXT

   <img width="513" alt="3e" src="https://user-images.githubusercontent.com/93085602/143682567-f759a1c4-72b8-4b49-a8b9-dfbbea3e7418.PNG">

4. NEXT

   <img width="512" alt="4e" src="https://user-images.githubusercontent.com/93085602/143682582-800e1008-7055-42c7-bdec-e10c7d50dd8e.PNG">

5. Pada "Additional Option" isilah Domain Name lalu NEXT

   <img width="510" alt="5e" src="https://user-images.githubusercontent.com/93085602/143682629-62477db9-749f-4432-b34c-568621366882.PNG">

6. Path akan kita gunakan setting default nya

   <img width="513" alt="6e" src="https://user-images.githubusercontent.com/93085602/143682662-13a7c12b-e07d-4bc3-be66-9f096a8653c1.PNG">

7. Tampilan penjelasan tentang apa yang sudah kita setting sebelumnya, lanjut NEXT

   <img width="514" alt="7e" src="https://user-images.githubusercontent.com/93085602/143682685-a89e9f1a-e265-420e-b6c2-28dea3d506c0.PNG">

8. Muncul peringatan seperti berikut. Pilih INSTALL

   <img width="510" alt="8e" src="https://user-images.githubusercontent.com/93085602/143682705-9810640f-5812-4531-852d-d5354683e765.PNG">

9. Setelah instalasi selesai, windows server 2022 akan me restart dan akan masuk desktop lagi

   <img width="512" alt="10e" src="https://user-images.githubusercontent.com/93085602/143682735-eee464e0-353f-4fa1-943e-835fb6b47608.PNG">

10. Pilih menu <b>input -> keyboard -> Insert Ctrl+Alt+Del</b>

   <img width="513" alt="11e" src="https://user-images.githubusercontent.com/93085602/143682780-88331b6b-4a5f-455e-90fa-0af115aacd8d.PNG">

11. Masukkan password

   <img width="511" alt="12e" src="https://user-images.githubusercontent.com/93085602/143682799-53f92e2f-9887-424f-b324-b7ab0deb8b1a.PNG">

12. Buka <b>"Server Manager"</b> dan notifikasi peringatan sudah tidak muncul

   <img width="514" alt="13e" src="https://user-images.githubusercontent.com/93085602/143682832-7d6444ac-3084-490b-a63d-95f907bce240.PNG">   

13. Buka "Command Prompt" lalu ping domain server (ex: ping evyra.sas) jika berhasil akan mendapatkan reply

   <img width="513" alt="15e" src="https://user-images.githubusercontent.com/93085602/143682927-1f59ccd4-6f54-490a-b1f6-ab753c292e6a.PNG">

14. Kembali ke <b>"Server Manager"</b> lalu pilih menu <b>"DNS"</b> lalu pilih menu tools "DNS"

   <img width="514" alt="16e" src="https://user-images.githubusercontent.com/93085602/143683005-cae782ac-6307-455f-898e-db4a7620b577.PNG">
...
15. Pilih "WIN-BEU2T60K3V0" yang tersedia lalu "Forward Lookup Zones" dan akan ada folder <b>"evyra.sas"</b> dan akan ditunjukkan domain yang sudah kita buat.
   ...
   <img width="513" alt="17e" src="https://user-images.githubusercontent.com/93085602/143683011-db993719-4e76-4305-8bdf-0c5bfd3c46c2.PNG">
